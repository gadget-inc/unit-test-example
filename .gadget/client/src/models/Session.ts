...
findOne: {
  ...
  },
  {
    ...
    optionsType: {} as FindOneSessionOptions,
...
maybeFindOne: {
  ...
  },
  {
    ...
    defaultSelection: DefaultSessionSelection,
    selectionType: {} as AvailableSessionSelection,
    optionsType: {} as MaybeFindOneSessionOptions,
    schemaType: null as Query["session"],
  } as const
)
...
findMany: {
  ...
  },
  {
    ...
    defaultSelection: DefaultSessionSelection,
    selectionType: {} as AvailableSessionSelection,
    optionsType: {} as FindManySessionsOptions,
    schemaType: null as Query["session"],
  } as const
);
...
findFirst: {
  ...
  },
  {
    ...
    defaultSelection: DefaultSessionSelection,
    selectionType: {} as AvailableSessionSelection,
    optionsType: {} as FindFirstSessionOptions,
    schemaType: null as Query["session"],
  } as const
);
...
maybeFindFirst: {
  ...
  },
  {
    ...
    defaultSelection: DefaultSessionSelection,
    selectionType: {} as AvailableSessionSelection,
    optionsType: {} as MaybeFindFirstSessionOptions,
    schemaType: null as Query["session"],
  } as const
);
