...
export class Client implements AnyClient {
  ...
  */
  ...
  developmentApiRoot = "https://unit-test-sample--development.gadget.app/";
  productionApiRoot = "https://unit-test-sample.gadget.app/";
  applicationId = "55192";
  ...
  constructor(options?: ClientOptions) {
    ...
    this.post = new PostManager(this.connection);
    ...
    this.internal = {
      ...
      post: new InternalModelManager("post", this.connection, {
